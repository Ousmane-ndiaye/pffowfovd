...
/**
 * When visiting the app_home, this listener redirects the user to the most
...
class RedirectToPreferredLocaleSubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelRequest(GetResponseEvent $event): void
    {
        ...
        // Ignore sub-requests and all URLs but the app_home
        ...
        if ($preferredLanguage !== $this->defaultLocale) {
            $response = new RedirectResponse($this->urlGenerator->generate('app_home', ['_locale' => $preferredLanguage]));
